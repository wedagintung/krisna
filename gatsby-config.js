...
module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        trackingId: 'G-ZEBNB795FQ' ,//`ADD YOUR TRACKING ID HERE`,
      },
    },
    {
    ...
    },
    {
      ...
      options: {
        endpoint: 'https://enjooymart.us12.list-manage.com/subscribe/post?u=797cdb524ca12511068eaaa96&amp;id=f810a36bd5', // add your MC list endpoint here; see instructions below
      },
    },
    {
